 ...
 *  Станция получает информацию от датчиков: температуры-DS18B20; давления-BME280/BMP280; 
 *  угла поворота-AS5600; скорости-OH137.
 ...
 *  Дополнительно станция отсылает напряжение VCC, уровень сигнала wifi в %.
